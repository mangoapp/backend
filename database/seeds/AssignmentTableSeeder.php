...
class AssignmentTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = array(
            ...
            ['id' => 5, 'section_id' => 1, 'category_id' => 1, 'quiz' => true, 'data' => json_encode(array('keyA' => 'dataA','keyB' => 'dataB')), 'title' => 'First Quiz', 'description' => 'Make sure you Pass!', 'filesubmission' => 0, 'maxScore' => 125, 'created_at' => new DateTime(), 'updated_at' => new DateTime()],
        );
