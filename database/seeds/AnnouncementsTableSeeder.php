...
class AnnouncementsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = array(
            ...
            ['id' => 4, 'user_id' => 1, 'section_id' => 2, 'title' => 'Section Update', 'body' => 'This is a section for just the cool students. If you are reading this, you are super cool!', 'created_at' => new DateTime(), 'updated_at' => new DateTime()]
        );
